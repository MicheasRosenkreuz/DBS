...
Create table pacient (
	...
	email Varchar(100),
 Primary Key (pacient_rc)) ENGINE = InnoDB;
...
Create table zaznam (
	...
	recept_id Int,
 Primary Key (pacient_rc,datum)) ENGINE = InnoDB;
...
Create table lekar (
 ...
 Primary Key (lekar_id)) ENGINE = InnoDB;

Create table nemocnice (
	nemocnice_id Int NOT NULL,
	adresa Varchar(200) NOT NULL,
	telefon Varchar(13) NOT NULL,
 Primary Key (nemocnice_id)) ENGINE = InnoDB;
...
Create table leky (
	...
	UNIQUE (jmeno),
 Primary Key (lek_id)) ENGINE = InnoDB;

Create table pojistovna (
	kod_pojistovny Int NOT NULL,
	nazev Varchar(100) NOT NULL,
 Primary Key (kod_pojistovny)) ENGINE = InnoDB;
...
Create table recept (
 ...
 Primary Key (recept_id)) ENGINE = InnoDB;

Create table recept_leky (
	recept_id Int NOT NULL,
	lek_id Int NOT NULL,
 Primary Key (recept_id,lek_id)) ENGINE = InnoDB;
