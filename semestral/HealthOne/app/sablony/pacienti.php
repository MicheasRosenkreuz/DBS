        ...
        <div id="content" class="container">
            <div>
                <div class="col-sm-6 col-xs-6 prepinace">
                    <a href="?sel=all"><button class="btn btn-lg" id="vsechny">Všichni</button></a>
                    <a href="?sel=byid"><button class="btn btn-lg" id="splnene">Mnou léčené pacienty</button></a>  
                    <a href="?sel=add_pacient"><button class="btn btn-lg" id="splnene">Přidat pacienta</button></a> 					
                </div>
            </div>
